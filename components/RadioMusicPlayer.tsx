...
import { changePlayingStatus, changeSongProgress, getIPAddress, getSong, handlePlayPlayback, playPrevSong, setOnlineDevice, skipSong, updatePlaybackState } from '@/lib/radio';
import SongCard from './SongCard';
import { formatTime } from '@/lib/utils';
import ChangePlayingDevicePopup from './ChangePlayingDevicePopup';

const RadioMusicPlayer = () => {
    ...
    const [mode, setMode] = useState<'control' | 'playback' | 'initializing'>('initializing')
    ...
    return (
        <>
            ...
            <div className='sticky bottom-0 px-4 pb-4'>
                <div className='flex items-center bg-surface border border-border rounded-lg p-4 min-h-[86px]'>
                    {mode === 'playback' && <audio
                        ref={audioRef}
                    ...
                    <section className='flex flex-col items-center mx-5'>
                        ...
                        <div className='flex gap-2 items-center'>
                            ...
                            <div ref={progressRef} onClick={handleSeek} className={`relative w-[220px] ${mode === 'playback' && 'hover:cursor-pointer'}`}>
                                <div className='w-full h-1 rounded-full bg-secondary-background'></div>
...
export default RadioMusicPlayer;