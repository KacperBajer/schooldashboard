...
const SelectPlaylistBox = ({data, selected, setSelected}: Props) => {
  return (
    <button onClick={setSelected} className={`py-1.5 px-4 rounded-md border-2 ${selected ? "border-blue-800 bg-blue-600/10" : "border-border"} transition-all duration-200 hover:cursor-pointer flex flex-col items-center`}>
